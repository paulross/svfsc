...
void write_test_results(const t_test_results &results, std::ostream &os) {
    ...
    for (const auto &result: results) {
        os << std::left;
        os << std::setw(20) << result.function();
        ...
        os << std::setw(16) << std::setprecision(9) << result.exec_time();
        os << std::setw(16) << std::setprecision(3) << result.ms_per_mb();
        os << std::setw(16) << std::setprecision(1) << result.work_rate();
