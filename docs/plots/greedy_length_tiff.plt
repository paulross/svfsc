...
plot "greedy_length_tiff.dat" using ($1 / 1024):($2 / 1000) t "Time to Read TIFF Metadata." with linespoints axes x1y1 pt 3 lw 2, \
    "greedy_length_tiff.dat" using ($1 / 1024):4 t "Cache Misses." with linespoints axes x1y2 pt 3 lw 2
